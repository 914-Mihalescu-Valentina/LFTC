...
class Scanner:
    ...
    def is_constant(self,token):
        self.__fa.initializeFA("constants.in")
        patterns = [
            r'^(0|((-|\+)|([1-9][0-9]*)))$',
            r'^"[a-zA-Z ]*"$',
            r"^'[a-zA-Z0-9 ]'$"
        ...
        # if self.__fa.checkSequenceAccepted(self.__fa.getInitialState(),token,self.__fa.getFinalStates(),self.__fa.getTransitions()):
        #             return True
        # else:
        #             return False
